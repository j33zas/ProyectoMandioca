...
Shader "Character/Attack/Heavy"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			float4 screenColor2 = UNITY_SAMPLE_SCREENSPACE_TEXTURE(_GrabTexture,( float4( UnpackScaleNormal( tex2D( _TextureSample0, uv_TextureSample0 ), _Scale ) , 0.0 ) + appendResult8 ).xy);
...
/*ASEBEGIN
Version=17200
0;377;1089;312;710.248;-170.1678;1;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;5;-1307.157,110.893;Inherit;False;Property;_Scale;Scale;1;0;Create;True;0;0;False;0;0;0.06;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ScreenColorNode;2;-273.118,32.18938;Inherit;False;Global;_GrabScreen0;Grab Screen 0;1;0;Create;True;0;0;False;0;Object;-1;False;False;1;0;FLOAT2;0,0;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;11;-276.0094,298.3584;Inherit;False;Property;_OpacityDistortion;OpacityDistortion;2;0;Create;True;0;0;False;0;0;0.3764706;0;1;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=1B966BC9E4A752E083C8E6D54DDA0D16CCC8ADDD