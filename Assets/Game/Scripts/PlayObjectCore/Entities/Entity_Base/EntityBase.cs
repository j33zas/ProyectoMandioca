...
public abstract class EntityBase : PlayObject 
{
    ...
    public virtual Attack_Result TakeDamage(int dmg, Vector3 attackDir, Damagetype damagetype, EntityBase owner_entity) { return TakeDamage(dmg, attackDir, damagetype); }
}
