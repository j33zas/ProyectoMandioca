...
public class UI_Anim_Code : UI_AnimBase
{
    ...
    public void OnGo(float time_value) { transform.localPosition = Vector3.Lerp(hidepos, currentpos, time_value); }
    public void OnBack(float time_value) { transform.localPosition = Vector3.Lerp(currentpos, hidepos, time_value); }
